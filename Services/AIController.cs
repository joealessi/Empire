       ...
       private UnitProductionOrder DecideWhatToBuild(Structure structure, Player aiPlayer)
{
    ...
    // Try to build priority units if capacity allows
    if (armies < 5)
    {
        if (baseStructure != null && baseStructure.CanBuildUnit(typeof(Army)))
            return new UnitProductionOrder(typeof(Army), 30, "Army");
        else if (city != null && city.CanBuildUnit(typeof(Army)))
            return new UnitProductionOrder(typeof(Army), 30, "Army");
    }
    
    if (tanks < 3)
    {
        if (baseStructure != null && baseStructure.CanBuildUnit(typeof(Tank)))
            return new UnitProductionOrder(typeof(Tank), 60, "Tank");
        else if (city != null && city.CanBuildUnit(typeof(Tank)))
            return new UnitProductionOrder(typeof(Tank), 60, "Tank");
    }
    
    if (fighters < 2)
    {
        if (baseStructure != null && baseStructure.CanBuildUnit(typeof(Fighter)))
            return new UnitProductionOrder(typeof(Fighter), 70, "Fighter");
        else if (city != null && city.CanBuildUnit(typeof(Fighter)))
            return new UnitProductionOrder(typeof(Fighter), 70, "Fighter");
    }
    
    if (baseStructure != null && baseStructure.HasShipyard && rand.NextDouble() < 0.3)
    {
        if (baseStructure.CanBuildUnit(typeof(Destroyer)))
            return new UnitProductionOrder(typeof(Destroyer), 80, "Destroyer");
    }
    
    // Random choice among what we can build
    var options = new List<UnitProductionOrder>();
    
    if (baseStructure != null)
    {
        if (baseStructure.CanBuildUnit(typeof(Army)))
            options.Add(new UnitProductionOrder(typeof(Army), 30, "Army"));
        if (baseStructure.CanBuildUnit(typeof(Tank)))
            options.Add(new UnitProductionOrder(typeof(Tank), 60, "Tank"));
        if (baseStructure.CanBuildUnit(typeof(Artillery)))
            options.Add(new UnitProductionOrder(typeof(Artillery), 50, "Artillery"));
        if (baseStructure.CanBuildUnit(typeof(Fighter)))
            options.Add(new UnitProductionOrder(typeof(Fighter), 70, "Fighter"));
    }
    else if (city != null)
    {
        if (city.CanBuildUnit(typeof(Army)))
            options.Add(new UnitProductionOrder(typeof(Army), 30, "Army"));
        if (city.CanBuildUnit(typeof(Tank)))
            options.Add(new UnitProductionOrder(typeof(Tank), 60, "Tank"));
        if (city.CanBuildUnit(typeof(Artillery)))
            options.Add(new UnitProductionOrder(typeof(Artillery), 50, "Artillery"));
        if (city.CanBuildUnit(typeof(Fighter)))
            options.Add(new UnitProductionOrder(typeof(Fighter), 70, "Fighter"));
    }
